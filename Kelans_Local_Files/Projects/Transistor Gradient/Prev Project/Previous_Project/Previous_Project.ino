    ...
    if (currentPage == '5'){ // Process
      ...
      if (once == 0){
        ...
        for (int x = 0; x <= n2; x++){
            ...
            itoa (timeB,buffer,x);
            myGLCD.print(buffer, 90, 170); // Prints the string
        }
...
//        mySwitch.send("10001110000010000101111000000000");
        ...
        myGLCD.fillRoundRect (35,150, 100, 170);
        myGLCD.setColor(255, 255, 255); // Sets color to white
        myGLCD.print("T1 Done at time(in sec.): DONE ALL", 35, 150); // Prints the string
        ...
        for (int x = 0; x <= N; x++){    
          ...
          myGLCD.fillRoundRect (35,170, 100, 190);
          myGLCD.setColor(255, 255, 255); // Sets color to white
          myGLCD.print("DONE!!!", 35, 170); // Prints the string
          ...
          myGLCD.print(buffer,75, 93);
          myGLCD.print("DONE !!!",85, 93);
          digitalWrite(VALVE, HIGH);
          delay((time3 - time2) * 60000 * 0 + 1);
          ...
          myGLCD.setColor(255, 255, 255); // Sets color to white
          myGLCD.print("T3 Done at time T3 + T2&T1_delay", 35, 190); // Prints the string
//
//            // Button - Back
//          myGLCD.setColor(16, 167, 103);// Sets green color
//          myGLCD.fillRoundRect (5,5, 55, 37);// Draws filled rounded rectangle
